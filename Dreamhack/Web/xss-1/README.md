# Write-up of the challenge "Xss-1"
...
So what this does is just redirect you to **/memo** and send the **cookies** from the admin bot that will get printed in the **/memo** endpoint.
